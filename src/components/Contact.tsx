            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-[#262626] text-white focus:border-[#F5B700] focus:ring-2 focus:ring-[#F5B700] focus:ring-opacity-50 transition-all duration-300 outline-none placeholder-gray-400"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-[#262626] text-white focus:border-[#F5B700] focus:ring-2 focus:ring-[#F5B700] focus:ring-opacity-50 transition-all duration-300 outline-none resize-none placeholder-gray-400"
